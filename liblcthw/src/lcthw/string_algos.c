...
static inline void String_setup_skip_chars(size_t * skip_chars, 
  ...
  assert(needle != NULL && "Given bad needle for skip chars function");
...
static void StringScanner_set_needle(StringScanner * scan, bstring tofind){
  assert(scan != NULL && "StringScanner is invalid");
...
int StringScanner_scan(StringScanner * scan, bstring tofind){
  check(scan != NULL,"StringScanner is Invalid");
